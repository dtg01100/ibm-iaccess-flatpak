#!/bin/sh
# Test variant: GTK2 Look-and-Feel (current/default)
# Best compatibility, conservative choice
...
# Force GTK for Java on KDE
export GDK_BACKEND=x11
export SWT_GTK3=0

# Read look-and-feel from environment
SWING_LAF="${SWING_LAF:-com.sun.java.swing.plaf.gtk.GTKLookAndFeel}"
JDK_GTK_VERSION="${JDK_GTK_VERSION:-2}"
